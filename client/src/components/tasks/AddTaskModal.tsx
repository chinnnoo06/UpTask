...
import type { TTaskForm } from '@/types/index';
...
export default function AddTaskModal() {
    ...
    const handleCreateTask = (formData: TTaskForm) => {
        const data = {
            formData,
            projectId
        }
                        ...
                        <div className="flex min-h-full items-center justify-center p-4 text-center">
                            ...
                            >
                                <Dialog.Panel className="w-full max-w-4xl transform overflow-hidden rounded-2xl bg-white text-left align-middle shadow-xl transition-all p-10">
                                    ...
                                    <form className="mt-10 bg-white shadow-lg p-10 rounded-lg space-y-3"
