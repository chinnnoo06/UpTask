...
import { getProjectTeam, removeMemberById } from "@/services/Team.service"
...
export const ProjectTeamView = () => {
  ...
  if (data) return (
    <>
      <h1 className="text-5xl font-black">Administrar Equupo</h1>
      <p className="text-2xl font-light text-gray-500 mt-5">Administre el equipo de trabajo para este proyecto</p>
                    ...
                    <Menu.Items className="absolute right-0 z-10 mt-2 w-56 origin-top-right rounded-md bg-white py-2 shadow-lg ring-1 ring-gray-900/5 focus:outline-none">
                      <Menu.Item>
                        <button
                          ...
                          type='button'
                          className='block px-3 py-1 text-sm leading-6 text-red-500 disabled:opacity-65'
                        >
